            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <article class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div class="relative h-64 overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1505751172876-fa1923c5c528?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Cardiovascular Health" class="w-full h-full object-cover transition-transform duration-300 hover:scale-105">
                    ...
                    <div class="p-6">
                        ...
                        <!-- Title -->
                        <h3 class="text-xl font-bold mb-3 text-gray-900 hover:text-green-600 transition-colors">Understanding Cardiovascular Health</h3>
                        
                        <!-- Description -->
                        <p class="text-gray-600 mb-4">Learn about the latest research on heart health and practical steps you can take to improve your cardiovascular system. Discover evidence-based strategies recommended by leading cardiologists.</p>
                        ...
                        <div class="flex items-center mb-4">
                            ...
                            <div>
                                <span class="block text-sm font-medium text-gray-900">Dr. Alex Johnson</span>
                                <span class="block text-xs text-gray-500">Cardiologist</span>
                            </div>
                        </div>
                ...
                <article class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <!-- CTA Button -->
                        <a href="#" class="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors w-full justify-center">
                            Read Full Article
                            <svg class="ml-2 -mr-1 w-4 h-4" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                            </svg>
